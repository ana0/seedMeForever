...
db.serialize(async () => {
  ...
  db.run("CREATE TABLE IF NOT EXISTS archive (id INTEGER PRIMARY KEY ASC, scientificName TEXT, name TEXT, filename TEXT, hash TEXT, comments TEXT, approved INTEGER)");
});
